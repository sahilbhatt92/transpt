@extends('app')
@section('title')
	Update Issue Bill | Transport Management Software
@stop
...
<div class="row">
			{!! Form::model($issuebill,['route'=>['issuebill.update',$issuebill->id],'method'=>'PATCH']) !!}
	<div class="col-lg-8 col-lg-offset-2">
	<div class="panel panel-default">
	    <div class="panel-heading">
			<div class="row">
				<div class="col-lg-8">
					<h4 class="">Update Issue Bill</h4>
				</div>
				<div class="col-lg-4">
	    ...
	    <div class="panel-body">
			...
			@include('issuebill.form',['disabled'=>1])
		</div>
	</div>
	</div>
			{!! Form::close() !!}
