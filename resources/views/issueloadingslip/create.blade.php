@extends('app')
@section('title')
	Issue New Loading Slip | Transport Management Software
@stop
...
<div class="row">
			{!! Form::open(['route'=>'issueloadingslip.store']) !!}
	<div class="col-lg-8 col-lg-offset-2">
	<div class="panel panel-default">
	    <div class="panel-heading">
			<div class="row">
				<div class="col-lg-8">
					<h4 class="">Issue New Loading Slip</h4>
				</div>
				<div class="col-lg-4">
	    ...
	    <div class="panel-body">
			...
			@include('issueloadingslip.form',['disabled'=>0])
		</div>
	</div>
	</div>
			{!! Form::close() !!}
