@extends('app')
@section('title')
	Update Invoice | Transport Management Software
@stop
...
<div class="row">
	...
	<div class="panel panel-default">
	    <div class="panel-heading">
			<div class="row">
				<div class="col-lg-8">
					<h4 class="">Update Invoice</h4>
				</div>
				<div class="col-lg-4">
					<a href="{{route('invoice.index')}}" class="btn btn-danger pull-right"><i class="glyphicon glyphicon-ban-circle"></i> Cancel</a>	
